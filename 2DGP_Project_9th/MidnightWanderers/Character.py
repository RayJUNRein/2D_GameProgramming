...
class Character:
    ...
    def update(self, frame_time):
        ...
        if self.state == self.LEFT_STAND:
            ...
            Character.FRAMES_PER_ACTION = character_data['Lou']['RIGHT_STAND']['frames_per_action']
            self.clip_width = character_data['Lou']['RIGHT_STAND']['clip_width']
            self.clip_height = character_data['Lou']['RIGHT_STAND']['clip_height']
        ...
        #if self.gwroad != None:
        #    self.x = clamp(30, self.x, self.road.w + self.gwroad.x - 30)
    ...
    def draw(self, frame_time):
        if self.gwroad.draw_status == True:
            self.image.clip_draw(self.frame * self.clip_width, 0, self.clip_width, self.clip_height, self.x - self.gwroad.window_left, self.y - self.gwroad.window_bottom)
        else:
