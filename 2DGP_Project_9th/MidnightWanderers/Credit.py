...
class Credit:
    ...
    def draw(self, frame_time):
        ...
        self.image.clip_draw(self.frame_x, self.frame_y, self.draw_width, self.draw_height, self.canvas_width - 275, 10)
        ...
        self.image.clip_draw(self.frame_x, self.frame_y, self.draw_width, self.draw_height, self.canvas_width - 250, 10)
        ...
        self.image.clip_draw(self.frame_x, self.frame_y, self.draw_width, self.draw_height, self.canvas_width - 225, 10)
        ...
        self.image.clip_draw(self.frame_x, self.frame_y, self.draw_width, self.draw_height, self.canvas_width - 200, 10)
        ...
        self.image.clip_draw(self.frame_x, self.frame_y, self.draw_width, self.draw_height, self.canvas_width - 175, 10)
        ...
        self.image.clip_draw(self.frame_x, self.frame_y, self.draw_width, self.draw_height, self.canvas_width - 150, 10)
        ...
        if self.credit_num == 0:
            ...
            self.image.clip_draw(self.frame_x, self.frame_y, self.draw_width, self.draw_height, self.canvas_width - 100, 10)
