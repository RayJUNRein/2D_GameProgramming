...
class Background:
    ...
    def __init__(self):
        if Background.image == None:
            Background.image = load_image('Resources\Levels_1\Background\MidnightWanderers_Levels_1_Background2.png')
        self.canvas_width = get_canvas_width()
        self.canvas_height = get_canvas_height()
        self.w = Background.image.w
        self.h = Background.image.h
    ...
    def draw(self, frame_time):
        Background.image.clip_draw_to_origin(self.q31, self.q3b, self.q3w, self.q3h, 0, 0)
        Background.image.clip_draw_to_origin(self.q21, self.q2b, self.q2w, self.q2h, 0, self.q3h)
        Background.image.clip_draw_to_origin(self.q41, self.q4b, self.q4w, self.q4h, self.q3w, 0)
        Background.image.clip_draw_to_origin(self.q11, self.q1b, self.q1w, self.q1h, self.q3w, self.q3h)
